...
let UserService = class UserService {
    ...
    async sendEmail(email) {
        ...
        const oAuthClient = new googleapis_1.google.auth.OAuth2(config_1.config.CLIENT_ID, config_1.config.CLIENT_SECRET, config_1.config.REDIRECT_URI);
        oAuthClient.setCredentials({ refresh_token: config_1.config.REFRESH_TOKEN });
            ...
            try {
                ...
                const transport = nodemailer.createTransport({
                    ...
                    auth: {
                        ...
                        clientSecret: config_1.config.CLIENT_SECRET,
                        refreshToken: config_1.config.REFRESH_TOKEN,
